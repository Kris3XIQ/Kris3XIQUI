...
a:SetScript("OnEvent", function(self)
    ...
    -- PlayerFrame:SetPoint("RIGHT", UIParent, "CENTER", -400, 200)
    ...
    -- Player casting bar setup
    PlayerCastingBarFrame:SetScale(1.2)
...
DEFAULT_CHAT_FRAME:AddMessage("|cffFF7D0A3XIQ: |r|cFF33FF22Core loaded successfully|r")
